...
public Action:Command_WeaponMenu(iClient, iArgs)
{
	...
	if (IsPlayerAlive(iClient))
	{
		...
		AddMenuItem(hMenu, "0", "医疗用品");
		AddMenuItem(hMenu, "1", "工具");
		AddMenuItem(hMenu, "2", "手枪");
		AddMenuItem(hMenu, "3", "冲锋枪");
		AddMenuItem(hMenu, "4", "步枪");
		AddMenuItem(hMenu, "5", "霰弹枪");
		AddMenuItem(hMenu, "6", "近战武器");
		AddMenuItem(hMenu, "7", "炸药");
